							...
							<div class="row">
								<div class="col-lg-12">
									...
									<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="../router.php" method="post">
										<input type="hidden" name="action" value="secteur">
										<?php if (isset($_GET['id_secteur'])) {
											$secteur = Secteur::getByID($_GET['id_secteur']);
											?>
												<input type="hidden" name="traitement" value="edit">
												<input type="hidden" name="id_secteur" value="<?=$_GET['id_secteur']; ?>">
											<?php
											}else{
											?>
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												...
												<div class="col-lg-6 controller">
													...
													<input type="text" name="libelle_secteur" class="form-control m-input" placeholder="Libellé secteur..." <?php if (isset($_GET['id_secteur'])) {
														echo 'value="'.$secteur['libelle_secteur'].'"';
													} ?>>
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												...
												<table class="m-datatable" id="html_table" width="100%">
													...
													<tbody>
														<?php 
															$resultats = Secteur::getSecteurList();
															foreach ($resultats as $resultat) {
													    		echo "<tr>
													    			<td>".$resultat['id_secteur']."</td>
													    			<td>".$resultat['libelle_secteur']."</td>
													    			
													    			<td>
													    				<div class='row'>
														    				<div class='col-md-6'>
														    					<a class='reset_link' href='/pages/addsecteur.php?id_secteur=".$resultat['id_secteur']."'><i class='flaticon-edit-1'></i></a>
														    				</div>
														    				<div class='col-md-6'>
														    					<a class='reset_link' href='../router.php?action=secteur&traitement=delete&id=".$resultat['id_secteur']."'><i class='flaticon-circle'></i></a>
														    				</div>
													    				</div>
