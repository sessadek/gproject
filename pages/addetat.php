							...
							<div class="row">
								<div class="col-lg-12">
									...
									<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="../router.php" method="post">
										...
										<?php if (isset($_GET['id_etat'])) {
											$etat = Etat::getByID($_GET['id_etat']);
											?>
												<input type="hidden" name="traitement" value="edit">
												<input type="hidden" name="id_etat" value="<?=$_GET['id_etat']; ?>">
											<?php
											}else{
											?>
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<div class="col-lg-12">
													<h2>Ajouter un etat de projet :</h2>
												</div>
												<div class="col-lg-6 controller">
													<label>
														Etat de projet :
													</label>
													<input type="text" name="libelle_etat" class="form-control m-input" placeholder="Etat de projet..." <?php if (isset($_GET['id_etat'])) {
														echo 'value="'.$etat['libelle_etat'].'"';
													} ?>>
								...
								<div class="col-lg-12">
									...
									<!--begin::Form-->
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<div class="col-lg-12">
													<h2>Liste des etats de projet :</h2>
												...
												<table class="m-datatable" id="html_table" width="100%">
													...
													<tbody>
														<?php 
															$resultats = Etat::getetatlist();
															foreach ($resultats as $resultat) {
													    		echo "<tr>
													    			<td>".$resultat['id_etat']."</td>
													    			<td>".$resultat['libelle_etat']."</td>
													    			
													    			<td>
													    				<div class='row'>
														    				<div class='col-md-6'>
														    					<a class='reset_link' href='/pages/addetat.php?id_etat=".$resultat['id_etat']."'><i class='flaticon-edit-1'></i></a>
														    				</div>
														    				<div class='col-md-6'>
														    					<a class='reset_link' href='../router.php?action=etat&traitement=delete&id=".$resultat['id_etat']."'><i class='flaticon-circle'></i></a>
														    				</div>
													    				</div>
