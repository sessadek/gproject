												...
												<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
													<div class="row align-items-center">
														...
														<div class="col-xl-4 order-1 order-xl-2 m--align-right">
															<a href="addsociete.php" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
																<span>
													    		...
													    		echo "<tr>
													    			...
													    			<script type='text/javascript'>
																		$(function () {
																		  ...
																		  $('#note_".$resultat['id_societe']."').rateYo({
																		  	rating: ".$resultat['note'].",
																		  	starWidth: '15px',
													    					readOnly: true
																		  });
													    			...
													    			<td>".$resultat['tele']."</td>
													    			<td>".$resultat['contact_principale_nom']."</td>
													    			<td>".$resultat['contact_principale_tele']."</td>
													    			<td>".$resultat['email']."</td>
													    			<td>".date('d-m-Y',strtotime($resultat['create_at']))."</td>
													    			<td>
													    				<div class='row'>
														    				<div class='col-md-6'>
														    					<a class='reset_link' href='/pages/addsociete.php?id_societe=".$resultat['id_societe']."'><i class='flaticon-edit-1'></i></a>
														    				</div>
														    				<div class='col-md-6'>
														    					<a class='reset_link' href='../router.php?action=societe&traitement=delete&id=".$resultat['id_societe']."'><i class='flaticon-circle'></i></a>
														    				</div>
													    				</div>
