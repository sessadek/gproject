							...
							<div class="row">
								<div class="col-lg-12">
									...
									<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="../router.php" method="post">
										...
										<?php if (isset($_GET['id_paiment'])) {
											$etat = Paiment::getByID($_GET['id_paiment']);
											?>
												<input type="hidden" name="traitement" value="edit">
												<input type="hidden" name="id_paiment" value="<?=$_GET['id_paiment']; ?>">
											<?php
											}else{
											?>
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<div class="col-lg-12">
													<h2>Ajouter un etat de paiement :</h2>
												</div>
												<div class="col-lg-6 controller">
													<label>
														Etat de paiement :
													</label>
													<input type="text" name="libelle_paiment" class="form-control m-input" placeholder="Etat de paiement..." <?php if (isset($_GET['id_paiment'])) {
														echo 'value="'.$etat['libelle_paiment'].'"';
													} ?>>
								...
								<div class="col-lg-12">
									...
									<!--begin::Form-->
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<div class="col-lg-12">
													<h2>Liste des états de paiement :</h2>
												...
												<table class="m-datatable" id="html_table" width="100%">
													...
													<tbody>
														<?php 
															$resultats = Paiment::getpaiementlist();
															foreach ($resultats as $resultat) {
													    		echo "<tr>
													    			<td>".$resultat['id_paiment']."</td>
													    			<td>".$resultat['libelle_paiment']."</td>
													    			
													    			<td>
													    				<div class='row'>
														    				<div class='col-md-6'>
														    					<a class='reset_link' href='/pages/addpaiement.php?id_paiment=".$resultat['id_paiment']."'><i class='flaticon-edit-1'></i></a>
														    				</div>
														    				<div class='col-md-6'>
														    					<a class='reset_link' href='../router.php?action=paiement&traitement=delete&id=".$resultat['id_paiment']."'><i class='flaticon-circle'></i></a>
														    				</div>
													    				</div>
